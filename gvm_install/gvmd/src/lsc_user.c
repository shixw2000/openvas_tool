                      ...
                      gchar **private_key)
{
  GError *error;
  gsize length;
  char key_dir[] = "/opt/openvas_key_XXXXXX";
  gchar *key_path = NULL;
  int ret = -1;
                     ...
                     const gchar *to_filename)
{
  ...
  gchar **cmd;
  char tmpdir[] = "/opt/lsc_user_rpm_create_XXXXXX";
...
{
  GError *error;
  char rpm_dir[] = "/opt/rpm_XXXXXX";
  char key_dir[] = "/opt/key_XXXXXX";
                     ...
                     const gchar *maintainer)
{
  ...
  gchar *pubkey_basename = NULL;
  gchar **cmd;
  char tmpdir[] = "/opt/lsc_user_deb_create_XXXXXX";
  gboolean success = TRUE;
  gchar *standard_out = NULL;
  gchar *standard_err = NULL;
                     ...
                     const gchar *to_filename)
{
  gint exit_status;
  gchar **cmd;
  char tmpdir[] = "/opt/lsc_user_exe_create_XXXXXX";
