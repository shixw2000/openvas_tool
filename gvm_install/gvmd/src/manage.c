      ...
      if (strcasecmp (entity_name (step), "step") == 0)
        {
          ...
          gchar *gmp;
          int xsl_fd, xml_fd;
          char xsl_file_name[] = "/opt/gvmd-xsl-XXXXXX";
          FILE *xsl_file, *xml_file;
          char xml_file_name[] = "/opt/gvmd-xml-XXXXXX";
          char extra_xsl_file_name[] = "/opt/gvmd-extra-xsl-XXXXXX";
          char extra_xml_file_name[] = "/opt/gvmd-extra-xml-XXXXXX";
